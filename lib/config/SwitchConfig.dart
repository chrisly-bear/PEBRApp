...
// subfolder under which all the backups are stored, you can find it in the
...
const int SWITCH_TOOLBOX_BACKUP_FOLDER_ID = 1;
// subfolder under which all the csv files are stored
const int SWITCH_TOOLBOX_DATA_FOLDER_ID = 1;

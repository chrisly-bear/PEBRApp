...
void main() {
  test('Match found', () {
    ...
    final Patient patient = Patient(artNumber: "B/01/11111", birthday: DateTime(1994, 9, 27), gender: Gender.MALE(), phoneNumber: "+266-57-683-501");
  ...
  test('No Match found', () {
    ...
    final Patient patient = Patient(artNumber: "B/01/22222", birthday: DateTime(1994, 8, 11), gender: Gender.FEMALE(), phoneNumber: "+266-56-543-501");
    final dynamic p = getMatchingPatient(patients, patient);
    expect(p, null);
  });
}
